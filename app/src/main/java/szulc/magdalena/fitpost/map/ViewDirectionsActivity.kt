package szulc.magdalena.fitpost.map
...
import szulc.magdalena.fitpost.map.Helper.DirectionsJSONParser
...
//camera
    ...
    private fun drawPath(
        mLastLocation: Location?,
        location: szulc.magdalena.fitpost.map.remote.model.Location
    ) {
        if (polyline != null) {
            polyline!!.remove()
        }
